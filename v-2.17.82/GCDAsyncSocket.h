...
- (BOOL)wa_connectWithAddress4:(id)arg1 address6:(id)arg2 timeout:(double)arg3 error:(id *)arg4;
- (BOOL)wa_connectWithCFHost:(struct __CFHost *)arg1 onPort:(unsigned short)arg2 withTimeout:(double)arg3 error:(id *)arg4;
