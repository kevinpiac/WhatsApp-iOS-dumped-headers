...
@property(readonly, nonatomic) unsigned int dragType; // @synthesize dragType=_dragType;
...
- (void).cxx_destruct;
- (BOOL)canIncreaseFactorForCurrentDragType;
...
- (BOOL)isTargetPoint:(struct CGPoint)arg1 betweenLeftFrame:(struct CGRect)arg2 rightFrame:(struct CGRect)arg3;
