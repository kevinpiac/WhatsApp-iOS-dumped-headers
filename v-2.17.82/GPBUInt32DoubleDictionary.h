...
+ (id)dictionaryWithDoubles:(const double *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
...
- (BOOL)getDouble:(double *)arg1 forKey:(unsigned int)arg2;
...
- (id)initWithDoubles:(const double *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
- (id)init;
