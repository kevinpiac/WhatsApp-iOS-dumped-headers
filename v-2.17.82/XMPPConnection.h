...
@class NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSNumber, NSString, NSUUID, WAFieldStatsEventChatConnectionProbe, WAMessageHandler, WATimer, XMPPPassiveModeManager, XMPPStream;
...
@property(retain) NSUUID *connectionUUID; // @synthesize connectionUUID=_connectionUUID;
- (void).cxx_destruct;
