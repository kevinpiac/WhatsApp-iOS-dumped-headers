...
+ (id)dictionaryWithFloats:(const float *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
...
- (BOOL)getFloat:(float *)arg1 forKey:(unsigned int)arg2;
...
- (id)initWithFloats:(const float *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
- (id)init;
