...
+ (id)dictionaryWithDoubles:(const double *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
...
- (id)initWithDoubles:(const double *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
- (id)init;
