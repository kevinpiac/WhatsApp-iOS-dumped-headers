...
+ (id)dictionaryWithUInt32s:(const unsigned int *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
...
- (id)initWithUInt32s:(const unsigned int *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
- (id)init;
