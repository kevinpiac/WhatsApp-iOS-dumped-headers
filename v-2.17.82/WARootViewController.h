...
@class ChatManager, NSString, NSTimer, UILabel, UIView, WACallLogger, WAChatStorage, WACloudBackupManager, WAContactsStorage, WAGroupInviteJoinController, WASQLBackupManager, WASignalManager, WAStatusSessionManager, WATabBarController, WATimelockViewController, WAWindow;
...
@property(readonly, nonatomic) ChatManager *chatManager; // @synthesize chatManager=_chatManager;
