...
@property(nonatomic) BOOL shouldGoBack; // @synthesize shouldGoBack=_shouldGoBack;
@property(copy, nonatomic) CDUnknownBlockType completion; // @synthesize completion=_completion;
@property(nonatomic) int mode; // @synthesize mode=_mode;
@property(nonatomic) BOOL navigationRestricted; // @synthesize navigationRestricted=_navigationRestricted;
