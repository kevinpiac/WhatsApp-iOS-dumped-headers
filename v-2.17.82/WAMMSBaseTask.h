...
+ (id)absoluteURLToMediaObjectWithHostname:(id)arg1 mediaType:(unsigned int)arg2 hashIdentifier:(id)arg3 uploadToken:(id)arg4 authToken:(id)arg5 allowsDirectIP:(BOOL)arg6 taskType:(unsigned int)arg7 additionalQueryItems:(id)arg8;
+ (void)initialize;
