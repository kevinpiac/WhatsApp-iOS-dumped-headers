...
+ (id)formattedVerificationCodeFromCode:(id)arg1 groupingsPerRow:(int)arg2 formatForCaption:(BOOL)arg3;
...
- (void)setCameraVisible:(BOOL)arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
