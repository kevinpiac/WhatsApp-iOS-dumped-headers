...
- (id)initWithSubject:(id)arg1 description:(id)arg2 participantJIDs:(id)arg3 key:(id)arg4 locked:(BOOL)arg5 webClientRequestID:(id)arg6 completion:(CDUnknownBlockType)arg7;
