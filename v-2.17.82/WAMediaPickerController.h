...
@property(nonatomic) BOOL toolbarWaitForPopCompletion; // @synthesize toolbarWaitForPopCompletion=_toolbarWaitForPopCompletion;
...
- (void)webGIFViewController:(id)arg1 didSelectGIFForURL:(id)arg2 cacheURL:(id)arg3 previewURL:(id)arg4 thumbURL:(id)arg5 asset:(id)arg6 isVideoURL:(BOOL)arg7 aspectRatio:(struct CGSize)arg8;
- (void)handleSelectedGIFWebURL:(id)arg1 cacheURL:(id)arg2 previewURL:(id)arg3 thumbURL:(id)arg4 isVideoURL:(BOOL)arg5 asset:(id)arg6 gifProvider:(id)arg7 aspectRatio:(struct CGSize)arg8;
...
- (void)setInitiallySelectedAssetIdentifiers:(id)arg1 livePhotoAsGifIdentifiers:(id)arg2 preexistingExternalItemCount:(int)arg3;
