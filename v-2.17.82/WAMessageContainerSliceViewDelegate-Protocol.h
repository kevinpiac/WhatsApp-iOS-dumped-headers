...
- (void)messageContainerSliceViewDidStopLocationSharing:(WAMessage *)arg1;
- (void)messageContainerSliceViewDidRequestViewLiveLocation;
- (unsigned int)presentationContextForMessageContainerSliceView:(WAMessageContainerSliceView *)arg1;
