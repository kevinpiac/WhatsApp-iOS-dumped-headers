...
@property(nonatomic) BOOL hasFallbackLc; // @dynamic hasFallbackLc;
@property(nonatomic) BOOL hasFallbackLg; // @dynamic hasFallbackLg;
...
@property(readonly, nonatomic) unsigned int localizableParamsArray_Count; // @dynamic localizableParamsArray_Count;
...
@property(readonly, nonatomic) unsigned int paramsArray_Count; // @dynamic paramsArray_Count;
