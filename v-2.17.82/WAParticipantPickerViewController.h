...
@property(retain, nonatomic) NSMutableSet *removingJIDs; // @synthesize removingJIDs=_removingJIDs;
...
- (void)removeCompleted:(BOOL)arg1;
...
- (BOOL)isParticipantPickerModeGroupMemberSearch;
