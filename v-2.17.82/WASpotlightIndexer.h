...
- (BOOL)internalIndexSomeItemsUsingContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (BOOL)internalRunTaskWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)addIndexingDependency:(id)arg1;
- (void)setNeedsIndexing;
- (BOOL)contextContainsUnindexedItems:(id)arg1;
