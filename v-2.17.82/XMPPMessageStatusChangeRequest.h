...
@property(readonly, nonatomic) int editVersion; // @synthesize editVersion=_editVersion;
...
- (void).cxx_destruct;
- (id)initWithMessageStatus:(int)arg1 stanzaID:(id)arg2 fromJID:(id)arg3 participantJID:(id)arg4 editVersion:(int)arg5;
