...
@interface WAMessageDataItem : NSManagedObject
{
}

+ (id)fetchedResultsControllerForType:(short)arg1 inChatJID:(id)arg2 context:(id)arg3;
+ (void)initialize;
...
+ (BOOL)wouldInsertDataItemsFor:(id)arg1;
+ (unsigned int)insertDataItemsFromTextInMessage:(id)arg1 startingAtIndex:(int)arg2 excludingURLs:(id)arg3;
+ (void)enumerateURLsFor:(id)arg1 excludingURLs:(id)arg2 block:(CDUnknownBlockType)arg3;
+ (unsigned int)internalInsertDataItemsForMessageIfNeeded:(id)arg1;
+ (void)insertDataItemsAndUpdateSearchEngineIfNeededForMessages:(id)arg1;
...
- (void)setDate:(id)arg1 allowExternalSideEffects:(BOOL)arg2;
...
@property(nonatomic) BOOL ownsThumbnail; // @dynamic ownsThumbnail;
