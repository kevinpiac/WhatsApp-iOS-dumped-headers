...
+ (id)dictionaryWithUInt64s:(const unsigned long long *)arg1 forKeys:(const long long *)arg2 count:(unsigned int)arg3;
...
- (BOOL)getUInt64:(unsigned long long *)arg1 forKey:(long long)arg2;
...
- (id)initWithUInt64s:(const unsigned long long *)arg1 forKeys:(const long long *)arg2 count:(unsigned int)arg3;
- (id)init;
