...
@interface ChatManager : WAChatDataStoreCoordinator <XMPPConnectionDelegate, WAChatDataStoreDelegate, WAWebClientDelegate, WASyncManagerDelegate, WAContactsStorageDelegate>
{
    WAWebClient *_webClient;
    BOOL _didConnectCallbackRun;
    NSMutableOrderedSet *_outgoingMessagesToMerge;
    BOOL _serverBuildExpired;
    ...
    BOOL _didReachRegistrationDomain;
...
@property(nonatomic, getter=isTimelocked) BOOL timelocked; // @synthesize timelocked=_timelocked;
...
@property(nonatomic) BOOL addressBookReloadingInProgress; // @synthesize addressBookReloadingInProgress=_addressBookReloadingInProgress;
@property(readonly, copy, nonatomic) NSString *countryCode; // @synthesize countryCode=_countryCode;
@property(readonly, copy, nonatomic) NSString *phoneNumber; // @synthesize phoneNumber=_phoneNumber;
@property(nonatomic) int timelockReasonCode; // @synthesize timelockReasonCode=_timelockReasonCode;
...
@property(readonly, nonatomic) BOOL changeNumberIQInProgress; // @synthesize changeNumberIQInProgress=_changeNumberIQInProgress;
...
- (void)contactsStorageDidMigrateData:(id)arg1;
...
- (void)changeOutgoingChatState:(unsigned int)arg1 forJID:(id)arg2;
...
- (void)markStatusAsSeen:(id)arg1 onWebClient:(BOOL)arg2;
- (void)sendReadReceiptsForMessagesBeforeAndIncludingMessage:(id)arg1 inChatSession:(id)arg2;
- (void)markAsReadMessagesBeforeAndIncludingMessage:(id)arg1 inChatSession:(id)arg2 onWebClient:(BOOL)arg3 allowBadgeCountDecrements:(BOOL)arg4 sendReadReceipts:(BOOL)arg5;
- (void)markChatSession:(id)arg1 asRead:(BOOL)arg2 onWebClient:(BOOL)arg3 allowBadgeCountDecrements:(BOOL)arg4 sendReadReceipts:(BOOL)arg5;
...
- (BOOL)beginDomainFrontingRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)reset;
- (void)chatSessionTransactionDidInsertChatSession:(id)arg1;
...
- (BOOL)xmppConnection:(id)arg1 didReceiveMessages:(id)arg2 error:(out id *)arg3;
...
- (void)xmppConnection:(id)arg1 didReceiveRetryReceiptForStanzaID:(id)arg2 fromJID:(id)arg3 participantJID:(id)arg4 edit:(int)arg5 registrationId:(id)arg6 retryCount:(unsigned int)arg7;
...
- (void)xmppConnection:(id)arg1 didReceiveServerErrorAckForIncomingMessageWithStanzaID:(id)arg2 fromJID:(id)arg3 participantJID:(id)arg4 edit:(int)arg5;
...
- (unsigned int)xmppConnection:(id)arg1 statusChanged:(int)arg2 forOutgoingMessagesWithStanzas:(id)arg3 fromJID:(id)arg4 participantJID:(id)arg5 userData:(id)arg6;
- (void)xmppConnection:(id)arg1 chatStateChanged:(unsigned int)arg2 forJID:(id)arg3 participantJID:(id)arg4;
...
- (void)xmppConnection:(id)arg1 stateChanged:(unsigned long)arg2;
- (void)setupXMPP;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfNameChangeInChatSessions:(id)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfChatSessionMarkedAsNotSpam:(id)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfModifyTagUpdateOfChatSession:(id)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfStarred:(BOOL)arg2 messages:(id)arg3 inChatSession:(id)arg4;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfAllChatSessionsArchived:(BOOL)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfUpdatedPinnedStateOfChatSession:(id)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfUpdatedMuteStateOfStatusChatSession:(id)arg2;
- (void)chatDataStore:(id)arg1 shouldNotifyWebClientOfUpdatedArchiveStateOfChatSession:(id)arg2;
- (void)chatDataStoreDidDeleteAllChatSessions:(id)arg1;
- (void)chatDataStoreDidClearAllChatSessions:(id)arg1;
- (void)chatDataStore:(id)arg1 didBulkDeleteMessagesInChatSession:(id)arg2 beforeDate:(id)arg3 ofTypes:(id)arg4 shouldDeleteStarred:(BOOL)arg5;
...
@property(readonly, nonatomic) int numberOfNewUnreadMessagesSinceGoingToBackground;
- (id)fetchChatSessionInfosWithUnreadMessages;
...
- (void)webClient:(id)arg1 didSetStatusPrivacyTo:(int)arg2 jids:(id)arg3;
- (unsigned int)webClient:(id)arg1 didPin:(BOOL)arg2 chatWithJID:(id)arg3 pinDate:(id)arg4;
- (unsigned int)webClient:(id)arg1 didSetMute:(BOOL)arg2 ofStatusWithJID:(id)arg3;
- (id)webClient:(id)arg1 mostContactedChatsWithPreferredContentType:(int)arg2;
- (void)webClient:(id)arg1 vCardsFromKnownContactsForWhatsAppID:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (unsigned int)webClient:(id)arg1 didAddContact:(id)arg2;
- (id)webClient:(id)arg1 starredMessagesInChatWithJID:(id)arg2 olderThanMessageID:(id)arg3 limit:(unsigned int)arg4 gifOnly:(BOOL)arg5;
- (void)webclient:(id)arg1 fetchMessagesMatchingSearchTerm:(id)arg2 inChatWithJID:(id)arg3 offset:(unsigned int)arg4 limit:(unsigned int)arg5 completion:(CDUnknownBlockType)arg6;
- (id)allWhatsAppableContactsInWebClient:(id)arg1;
- (id)allChatSessionsInWebClient:(id)arg1;
- (void)webClient:(id)arg1 didSetBlockedState:(BOOL)arg2 ofUserWithJID:(id)arg3 reason:(id)arg4 requestInfo:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (void)webClient:(id)arg1 didRequestResendMessage:(id)arg2;
- (void)webClient:(id)arg1 didCreateGroupWithSubject:(id)arg2 participants:(id)arg3 requestInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)webClient:(id)arg1 didPromoteParticipantWithJID:(id)arg2 inChatWithJID:(id)arg3 requestInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)webClient:(id)arg1 didRequestMediaUploadForMessageID:(id)arg2 inChatWithJID:(id)arg3 extraRecipientJIDs:(id)arg4 requestID:(id)arg5;
...
- (void)webClient:(id)arg1 didSetSpamStatus:(BOOL)arg2 ofChatWithJID:(id)arg3 requestInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (unsigned int)webClient:(id)arg1 didUnstarAllMessagesInChatWithJID:(id)arg2;
- (unsigned int)didUnstarAllMessagesInWebClient:(id)arg1;
- (unsigned int)webClient:(id)arg1 didSetStarredState:(BOOL)arg2 ofMessageIDs:(id)arg3 inChatWithJID:(id)arg4;
- (unsigned int)webClient:(id)arg1 didSetMuteDate:(id)arg2 fromMuteDate:(id)arg3 ofChatWithJID:(id)arg4;
- (unsigned int)webClient:(id)arg1 didSetArchivedState:(BOOL)arg2 ofChatWithJID:(id)arg3 messageID:(id)arg4;
- (unsigned int)webClient:(id)arg1 didDeleteMessageIDs:(id)arg2 inChatWithJID:(id)arg3;
- (void)webClient:(id)arg1 didClearChatWithJID:(id)arg2 includingStarred:(BOOL)arg3 lastMessageID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (unsigned int)webClient:(id)arg1 didDeleteChatWithJID:(id)arg2 messageID:(id)arg3;
...
- (unsigned int)webClient:(id)arg1 hasSeenStatus:(id)arg2 inChatWithJID:(id)arg3;
- (unsigned int)webClient:(id)arg1 didReadUntilMessageID:(id)arg2 inChatWithJID:(id)arg3 readCount:(int)arg4;
- (BOOL)webClient:(id)arg1 didRelayMessage:(id)arg2;
...
- (id)webClient:(id)arg1 recentMessagesInChatSession:(id)arg2 activity:(int)arg3;
- (id)webClient:(id)arg1 memberJIDsInBroadcastList:(id)arg2;
- (id)webClient:(id)arg1 messagesInChatSession:(id)arg2 afterMessageID:(id)arg3 count:(unsigned int)arg4 countExceeded:(out char *)arg5;
- (id)webClient:(id)arg1 JIDToChatSessionMapWithJIDs:(id)arg2;
- (unsigned int)webClient:(id)arg1 countMediaMessagesInJID:(id)arg2;
- (unsigned int)webClient:(id)arg1 countMessagesInJID:(id)arg2 ofType:(int)arg3;
- (id)webClient:(id)arg1 mediaMessagesInJID:(id)arg2 count:(unsigned int)arg3 withOrder:(unsigned int)arg4 relativeToMessageID:(id)arg5;
- (id)webClient:(id)arg1 messagesInJID:(id)arg2 ofType:(int)arg3 count:(unsigned int)arg4 withOrder:(unsigned int)arg5 relativeToMessageID:(id)arg6;
- (id)webClient:(id)arg1 messagesInJID:(id)arg2 count:(unsigned int)arg3 withOrder:(unsigned int)arg4 relativeToMessageID:(id)arg5;
- (void)forwardMostContactedChatsToWebClient;
- (void)notifyWebClientOfGenericErrorCode:(int)arg1 requestID:(id)arg2;
- (void)notifyWebClientOfUpdatesToMessage:(id)arg1;
- (void)notifyWebClientOfMessageStatusChangeInMessage:(id)arg1;
@property(readonly, nonatomic, getter=isWebClientActive) BOOL webClientActive;
