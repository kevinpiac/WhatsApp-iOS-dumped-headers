...
@property(nonatomic) char *errorMessageDismissed; // @synthesize errorMessageDismissed=_errorMessageDismissed;
...
@property(nonatomic) BOOL headerStatus; // @synthesize headerStatus=_headerStatus;
- (void).cxx_destruct;
