...
@class CSSearchableIndex, NSMutableDictionary, NSString, WASpotlightPictureManager, WATaskQueue;
...
- (id)initWithProfilePictureManager:(id)arg1 resetAction:(CDUnknownBlockType)arg2;
