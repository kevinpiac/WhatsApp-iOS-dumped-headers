...
@class NSAttributedString, NSData, NSDate, NSManagedObjectID, NSNumber, NSPointerArray, NSSet, NSString, NSURL, UIColor, WAChatSession, WAFuture, WAGroupMember, WAMediaItem, WAMessageHelper, WAMessageID, WAMessageInfo, WAWeakTimer;
...
+ (id)messageTypeStringForMessageType:(int)arg1 mediaOrigin:(int)arg2 status:(int)arg3 systemEvent:(int)arg4 isFromMe:(BOOL)arg5 preferredColor:(id)arg6 fontSize:(float)arg7;
