...
+ (id)dictionaryWithObjects:(const id *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
...
- (id)initWithObjects:(const id *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned int)arg3;
- (id)init;
