...
{
    BOOL _locked;
    BOOL _announcementOnly;
    CDStruct_4a549e91 _expectedValues;
    NSString *_jid;
    NSString *_subject;
...
+ (id)groupFromGroupElement:(id)arg1 expetedValues:(CDStruct_4a549e91)arg2;
+ (id)groupFromGroupElement:(id)arg1;
@property(nonatomic) CDStruct_4a549e91 expectedValues; // @synthesize expectedValues=_expectedValues;
...
@property(nonatomic) BOOL announcementOnly; // @synthesize announcementOnly=_announcementOnly;
...
@property(readonly, nonatomic) BOOL hasGroupDescriptionValue;
