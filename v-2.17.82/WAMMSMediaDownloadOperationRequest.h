...
- (id)initWithMediaKey:(id)arg1 cellularAllowed:(BOOL)arg2 ciphertextHash:(id)arg3 ciphertextFilePath:(id)arg4 plaintextHash:(id)arg5 plaintextFilePath:(id)arg6;
