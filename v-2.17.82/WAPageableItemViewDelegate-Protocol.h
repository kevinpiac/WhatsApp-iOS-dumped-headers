...
@class UIViewController, WAPageableItemView, WAPaintBrushContent, WAPaintPositionSample;

@protocol WAPageableItemViewDelegate <NSObject>
- (void)pageableItemView:(WAPageableItemView *)arg1 replaceContentStamp:(WAPaintBrushContent *)arg2 sample:(WAPaintPositionSample *)arg3 newContent:(WAPaintBrushContent *)arg4;
