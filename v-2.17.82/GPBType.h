...
@property(readonly, nonatomic) unsigned int fieldsArray_Count; // @dynamic fieldsArray_Count;
...
@property(readonly, nonatomic) unsigned int oneofsArray_Count; // @dynamic oneofsArray_Count;
