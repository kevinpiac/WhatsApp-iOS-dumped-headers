...
@class NSArray, NSMapTable, NSSet, NSString, UITableViewCell, UIView, WAChatCellData, WAMessageContainer, _WANoHighlightImageView;
...
- (void)messageContainerSliceViewDidStopLocationSharing:(id)arg1;
- (void)messageContainerSliceViewDidRequestViewLiveLocation;
