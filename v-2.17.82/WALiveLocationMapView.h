...
- (void).cxx_destruct;
- (id)friendLocationAnnotationWithJID:(id)arg1;
...
- (struct WACluster *)mostSimilarClusterTo:(struct WACluster *)arg1 inClusters:(id)arg2;
...
- (double)distanceFromPoint:(CDStruct_c3b9c2ee)arg1 toPoint:(CDStruct_c3b9c2ee)arg2;
...
- (void)removeUnfilteredAnnotations:(id)arg1;
...
- (void)addOrUnhideAnnotations:(id)arg1;
