...
@property(readonly, nonatomic, getter=isScrubbingInProgress) BOOL scrubbingInProgress; // @synthesize scrubbingInProgress=_scrubbingInProgress;
...
- (void)setLoadedSet:(id)arg1 size:(unsigned int)arg2;
@property(readonly, nonatomic) unsigned int loadedSetSize;
