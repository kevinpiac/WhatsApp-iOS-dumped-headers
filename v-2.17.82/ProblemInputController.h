...
@class NSArray, NSObject, NSString, UIBarButtonItem, UIImage, UITableViewCell, UITapGestureRecognizer, UITextView, WADoneWithSpinnerBarButtonItem, WAHTTPFetcher, WAImageAttachmentContainerView;
...
@property(readonly, nonatomic) unsigned int numberOfFAQSearchResultsOpened; // @synthesize numberOfFAQSearchResultsOpened=_numberOfFAQSearchResultsOpened;
@property(readonly, nonatomic) unsigned int numberOfFAQSearchResultsReturned; // @synthesize numberOfFAQSearchResultsReturned=_numberOfFAQSearchResultsReturned;
...
@property(nonatomic) __weak id <ProblemInputControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
