...
+ (id)dictionaryWithInt64s:(const long long *)arg1 forKeys:(const char *)arg2 count:(unsigned int)arg3;
+ (id)dictionaryWithInt64:(long long)arg1 forKey:(BOOL)arg2;
+ (id)dictionary;
- (void)removeAll;
...
- (id)initWithInt64s:(const long long *)arg1 forKeys:(const char *)arg2 count:(unsigned int)arg3;
- (id)init;
