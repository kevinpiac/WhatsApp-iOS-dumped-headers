...
+ (id)controlsForOTPLength:(int)arg1 atmPinLength:(int)arg2 mPinLength:(int)arg3 nmPinLength:(int)arg4;
+ (id)configurationWithResendOTPButton:(BOOL)arg1 bankName:(id)arg2;
+ (id)keyCode;
