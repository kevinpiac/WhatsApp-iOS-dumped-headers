...
@class NSDate, NSDateFormatter, NSMutableDictionary, NSMutableSet, NSObject, NSString, WAContactsStorage, WAPersistentRequestManager, WASignalManager, WASyncManager, XMPPConnection;
@protocol OS_dispatch_queue;

@interface WABizManager : WAStorage <WAPersistentRequestManagerRegistering, WABizLookupProvider>
{
    NSMutableDictionary *_cachedVerifiedNames;
    NSMutableSet *_verifiedJIDs;
...
- (id)verifiedNameForJID:(id)arg1;
- (BOOL)isVerifiableJID:(id)arg1;
- (BOOL)internalHasVerifiedNameForJID:(id)arg1;
...
- (void)deleteAllExistingCertificatesForJID:(id)arg1 andRefetch:(BOOL)arg2;
