...
- (BOOL)contactPropertyEditingCellShouldReturn:(WAContactPropertyEditingCell *)arg1;
- (void)contactPropertyEditingCellDidEndEditing:(WAContactPropertyEditingCell *)arg1;
- (BOOL)contactPropertyEditingCellShouldEndEditing:(WAContactPropertyEditingCell *)arg1;
- (void)contactPropertyEditingCellDidBeginEditing:(WAContactPropertyEditingCell *)arg1;
- (BOOL)contactPropertyEditingCellShouldBeginEditing:(WAContactPropertyEditingCell *)arg1;
@end
