...
+ (id)dictionaryWithInt32s:(const int *)arg1 forKeys:(id *)arg2 count:(unsigned int)arg3;
...
- (id)initWithInt32s:(const int *)arg1 forKeys:(id *)arg2 count:(unsigned int)arg3;
- (id)init;
