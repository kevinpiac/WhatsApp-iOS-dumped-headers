...
@property(readonly, nonatomic) BOOL desireTransparentIconBackgrounds; // @synthesize desireTransparentIconBackgrounds=_desireTransparentIconBackgrounds;
- (void).cxx_destruct;
...
- (id)initWithTransparentIconBackgrounds:(BOOL)arg1;
