...
@property(nonatomic) unsigned int queryRetainCount; // @synthesize queryRetainCount=_queryRetainCount;
@property(nonatomic) __weak WACloudBackupManager_Documents *manager; // @synthesize manager=_manager;
@property(nonatomic, getter=isFinishedGathering) BOOL finishedGathering; // @synthesize finishedGathering=_finishedGathering;
- (void).cxx_destruct;
