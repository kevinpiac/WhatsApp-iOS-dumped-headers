...
+ (id)dictionaryWithBools:(const char *)arg1 forKeys:(const long long *)arg2 count:(unsigned int)arg3;
+ (id)dictionaryWithBool:(BOOL)arg1 forKey:(long long)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeBoolForKey:(long long)arg1;
- (void)setBool:(BOOL)arg1 forKey:(long long)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getBool:(char *)arg1 forKey:(long long)arg2;
...
- (id)initWithBools:(const char *)arg1 forKeys:(const long long *)arg2 count:(unsigned int)arg3;
- (id)init;
