...
@class CLLocation, CLLocationManager, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSURL, WAChatSession, WAChatSessionSpotlightIndexer, WAExactTimer, WAMessageSearchEngine, WAMessageSpotlightIndexer, WAMessagesBySessionTask, WASpotlightIndexer, WAStickerStartupManager, WATask;
...
@interface WAChatStorage : WAChatDataStore <CLLocationManagerDelegate, WAUpgradeCallback, WAChatStoragePIBackupProtocol, WAPersistentRequestManagerRegistering>
{
    ...
    unsigned int _unreadChatSessionCount;
    ...
    BOOL _searchEngineIndexingRapidly;
    unsigned int _searchEngineIndexingRapidlyCount;
...
@property(readonly, nonatomic) int newMessageCountSinceEnteringBackground;
...
- (BOOL)messageSearchNeedsMigration;
...
- (id)internalFetchChatHistoryForChatWithJID:(id)arg1 year:(int)arg2 context:(id)arg3;
...
- (id)sendMessageWithText:(id)arg1 metadata:(id)arg2 multicast:(BOOL)arg3 replyingToMessage:(id)arg4 quotingChatSession:(id)arg5 inChatSession:(id)arg6 hasTextFromURL:(BOOL)arg7 openedFromURL:(BOOL)arg8;
...
- (void)updateBackgroundMessageCountForNewUnreadMessage:(id)arg1 shouldBadge:(BOOL)arg2;
...
- (id)unreadEligibleMessagesForChatSession:(id)arg1 beforeSort:(int)arg2 limit:(int)arg3;
...
- (void)enumerateRelevantObjectsForJIDs:(id)arg1 options:(unsigned int)arg2 chatBlock:(CDUnknownBlockType)arg3 groupMemberBlock:(CDUnknownBlockType)arg4;
...
- (unsigned int)unarchivedUnreadChatSessionCount;
...
- (void)modifyUnreadChatSessionCountBy:(int)arg1;
@property(readonly, nonatomic) int unreadChatSessionCount;
...
- (void)setBalancedShouldIndexRapidly:(BOOL)arg1;
...
- (id)starredMessagesInChatSessionsWithJIDs:(id)arg1 olderThanMessageID:(id)arg2 startOffset:(unsigned int)arg3 limit:(unsigned int)arg4 gifOnly:(BOOL)arg5 inContext:(id)arg6;
...
- (id)messagesInChatSession:(id)arg1 ofType:(int)arg2 count:(unsigned int)arg3 sortOrder:(unsigned int)arg4 withRelation:(unsigned int)arg5 toMessageID:(id)arg6;
- (id)mediaMessagesInChatSession:(id)arg1 count:(unsigned int)arg2 sortOrder:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(id)arg5;
- (id)messagesInChatSession:(id)arg1 count:(unsigned int)arg2 sortOrder:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(id)arg5;
