...
+ (id)dictionaryWithUInt32s:(const unsigned int *)arg1 forKeys:(id *)arg2 count:(unsigned int)arg3;
...
- (BOOL)getUInt32:(unsigned int *)arg1 forKey:(id)arg2;
...
- (id)initWithUInt32s:(const unsigned int *)arg1 forKeys:(id *)arg2 count:(unsigned int)arg3;
- (id)init;
