...
- (BOOL)stickerCategoriesFlowLayoutShouldAddDecoration:(WAStickerCategoriesFlowLayout *)arg1;
- (BOOL)stickerCategoriesFlowLayout:(WAStickerCategoriesFlowLayout *)arg1 shouldProcessFinalLayoutWithIndexPath:(NSIndexPath *)arg2;
- (BOOL)stickerCategoriesFlowLayout:(WAStickerCategoriesFlowLayout *)arg1 shouldProcessInitialLayoutWithIndexPath:(NSIndexPath *)arg2;
- (void)stickerCategoriesFlowLayoutFinalizedUpdates:(WAStickerCategoriesFlowLayout *)arg1;
- (unsigned int)stickerCategoriesFlowLayoutCategoriesCount:(WAStickerCategoriesFlowLayout *)arg1;
