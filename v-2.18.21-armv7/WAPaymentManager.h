...
- (id)addOrUpdateTransaction:(id)arg1 ignoreTimestamp:(BOOL)arg2 messageDate:(id)arg3;
...
- (id)requestEditDefaultCredentialForDeviceId:(id)arg1 credentialId:(id)arg2 makeDefault:(BOOL)arg3;
...
- (id)requestUPIRegisterHandleForAccountNumber:(id)arg1 bankInfo:(id)arg2 deviceId:(id)arg3 defaultDebit:(BOOL)arg4 defaultCredit:(BOOL)arg5;
