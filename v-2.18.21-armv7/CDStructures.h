...
typedef struct {
    ...
    double video_initial_codec_type;
    double video_codec_sub_type;
    ...
    double video_upgrade_cancel_count;
    double video_upgrade_cancel_by_timeout_count;
    double video_upgrade_reject_count;
    double video_upgrade_reject_by_timeout_count;
...
typedef struct {
    ...
    int _field23;
    int _field24;
    struct wa_call_participant_detail_info_t _field25[4];
    int _field26;
    int _field27;
    int _field28;
    int _field29;
