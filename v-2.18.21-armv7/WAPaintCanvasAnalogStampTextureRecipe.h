...
- (void)rotateContext:(struct CGContext *)arg1 withAngle:(float)arg2 atCenter:(struct CGPoint)arg3;
- (void)drawImage:(id)arg1 inRect:(struct CGRect)arg2 context:(struct CGContext *)arg3 angle:(float)arg4 center:(struct CGPoint)arg5;
