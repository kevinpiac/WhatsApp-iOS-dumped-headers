...
+ (unsigned int)sortValueForFrequency:(unsigned int)arg1;
+ (void)wa_didUpgradeFrom:(id)arg1 to:(id)arg2;
+ (int)expirationDateMultiplierForInterval:(unsigned int)arg1;
@property(readonly, nonatomic) int expirationDateMultiplier; // @synthesize expirationDateMultiplier=_expirationDateMultiplier;
...
@property(nonatomic) BOOL badge; // @synthesize badge=_badge;
- (void).cxx_destruct;
...
- (void)refresh;
- (void)didChangeCodeFrom:(int)arg1 wasAutoBackupEnabled:(BOOL)arg2;
...
@property(readonly, nonatomic, getter=isBadgeMuted) BOOL badgeMuted;
