...
#import "WAPaymentCardViewDelegate-Protocol.h"

@class NSLayoutConstraint, UIBarButtonItem, UILabel, UIView, WAPaymentAccount, WAPaymentCardView;

@interface WAPaymentUPIDebitCardViewController : WAViewController <WAPaymentCardViewDelegate>
{
...
@property(retain, nonatomic) WAPaymentAccount *account; // @synthesize account=_account;
