...
- (id)mutableCopy;
- (id)copy;
@property(readonly, nonatomic) BOOL hasUpdatedIndexes;
@property(readonly, copy, nonatomic) NSIndexSet *updatedIndexes;
@property(readonly, nonatomic) BOOL hasRemovedIndexes;
@property(readonly, copy, nonatomic) NSIndexSet *removedIndexes;
@property(readonly, nonatomic) BOOL hasInsertedIndexes;
