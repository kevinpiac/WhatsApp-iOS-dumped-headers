...
@interface WACryptFileOperation : WATriggeredOperation
{
    ...
    void *_readBuffer;
    unsigned long _readBufferLength;
    void *_outputBuffer;
    unsigned long _outputBufferLength;
    NSString *_bestName;
...
@property BOOL hasNoConnectionError; // @synthesize hasNoConnectionError=_hasNoConnectionError;
@property BOOL hasEncryptionKeyError; // @synthesize hasEncryptionKeyError=_hasEncryptionKeyError;
...
- (BOOL)tryToCryptWithBackupHMAC:(CDStruct_43cfb2c2 *)arg1;
...
- (id)readFileHeader;
- (void)getHMACBytes:(void *)arg1 ofLength:(unsigned long)arg2;
- (BOOL)writeBytes:(const void *)arg1 ofLength:(unsigned long)arg2;
- (id)readDataOfLength:(unsigned int)arg1;
- (long)readBytes:(void *)arg1 ofLength:(unsigned long)arg2;
- (BOOL)succeeded;
