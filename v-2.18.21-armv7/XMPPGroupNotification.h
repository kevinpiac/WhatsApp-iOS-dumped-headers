...
@property(readonly, nonatomic, getter=isReceivedWithActiveWebClientSession) BOOL receivedWithActiveWebClientSession; // @synthesize receivedWithActiveWebClientSession=_receivedWithActiveWebClientSession;
@property(copy, nonatomic) XMPPAttributes *stanzaAttributes; // @synthesize stanzaAttributes=_stanzaAttributes;
@property(readonly, nonatomic) BOOL offlineStorage; // @synthesize offlineStorage=_offlineStorage;
