...
@property(nonatomic) BOOL allowsHeightIncrease; // @synthesize allowsHeightIncrease=_allowsHeightIncrease;
@property(nonatomic) BOOL allowsWidthIncrease; // @synthesize allowsWidthIncrease=_allowsWidthIncrease;
...
- (void)layoutSubviews;
@property(nonatomic) float cropGridAlpha;
@property(nonatomic) float rotationGridAlpha;
