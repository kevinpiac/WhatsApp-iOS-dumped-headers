...
- (void)audioRecorderEndInterruption:(AVAudioRecorder *)arg1 withFlags:(unsigned int)arg2;
- (void)audioRecorderEndInterruption:(AVAudioRecorder *)arg1 withOptions:(unsigned int)arg2;
