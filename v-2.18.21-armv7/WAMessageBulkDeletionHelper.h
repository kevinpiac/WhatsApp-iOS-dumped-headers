...
- (void)internalDeleteWithChatSessionID:(id)arg1 messageCounter:(int)arg2 readSort:(int)arg3 context:(id)arg4 detailPredicates:(id)arg5 fetchLimit:(unsigned int)arg6 completion:(CDUnknownBlockType)arg7;
