...
- (unsigned int)bottomPanelModeForController:(WAChatMessagesController *)arg1;
- (BOOL)controller:(WAChatMessagesController *)arg1 needsConfigureInsertedChatCellData:(WAChatCellData *)arg2;
- (BOOL)controller:(WAChatMessagesController *)arg1 shouldRemoveMessage:(WAMessage *)arg2;
...
- (void)controllerWillChangeContent:(WAChatMessagesController *)arg1 animated:(BOOL)arg2;
@end
