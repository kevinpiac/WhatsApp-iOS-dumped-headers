...
+ (id)dictionaryWithInt64s:(const long long *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
...
- (id)initWithInt64s:(const long long *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
- (id)init;
