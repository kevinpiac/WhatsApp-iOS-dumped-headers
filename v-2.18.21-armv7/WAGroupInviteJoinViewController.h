...
@interface WAGroupInviteJoinViewController : WAViewController <UIViewControllerTransitioningDelegate, WAExpandingTextViewControllerDelegate, WAGroupInviteJoinUISupport>
{
...
- (void)promptToJoinGroup:(id)arg1 inviteCode:(id)arg2 alreadyParticipant:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
