...
#import "WAChatSessionPersistentNotificationViewDelegate-Protocol.h"
...
@class NSArray, NSDictionary, NSMutableArray, NSNumber, NSString, NSTimer, NSUserActivity, UIButton, UIGestureRecognizer, UIImageView, UIImpactFeedbackGenerator, UITapGestureRecognizer, UIView, WAChatMessageInputView, WAChatSearchBar, WAChatSession, WAChatSessionPersistentNotificationView, WAConversationHeaderView, WAMMSMediaStreamingUploadOperation, WAMentionsSelectorView, WAMessage, WAMessageBubbleTableViewCell, WAProgressAlertController, WAPttRecorder, WAScrollToBottomButton, WAScrollToNextCatchUpButton, WASearchResultsController;
@protocol UIViewControllerPreviewing;

@interface WAChatViewController : WAChatMessagesViewController <WANavigationControllerPushAnimating, WAChatSessionPersistentNotificationViewDelegate, WAChatMessageInputViewDelegate, WAMentionsSelectorViewDelegate, UIGestureRecognizerDelegate, WAMultiSendMediaPickerControllerDelegate, WAMultiSendPreviewViewControllerDelegate, WAMultiShotCameraControllerDelegate, WAConversationHeaderViewDelegate, WAPttRecorderDelegate, WASearchResultsControllerDelegate, UISearchBarDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, WALiveLocationSender, WANewFriendsLocationViewControllerDelegate, WAShareLocationControllerDelegate, WAStatusViewerViewControllerDelegate, WANavigationItemCustomBackButtonTitle, WAParticipantPickerViewControllerDelegate, WAShareContactViewControllerDelegate>
{
    ...
    WAChatSessionPersistentNotificationView *_persistentNotificationView;
    BOOL _persistentNotificationIsDisappearing;
    NSString *_newJID;
    NSString *_oldJID;
    BOOL _isOldChatSession;
    BOOL _needsDescriptionNUXUntilDisappear;
    WAMessage *_lastCatchUpMessage;
    int _displayMessagesForCatchUpCount;
    NSMutableArray *_messagesForCatchUp;
    BOOL _needsUpdateGroupCatchUpMessagesForVisibleCells;
...
+ (BOOL)isChatViewControllerActive:(id)arg1;
...
- (void)updateScrollToActionButtonsAndIncrementMostRecentBy:(int)arg1;
- (void)updateScrollToActionButtons;
- (BOOL)shouldShowScrollToNextCatchUpButton;
- (BOOL)shouldShowScrollToMostRecentButton;
- (float)distanceFromBottomInPoints;
...
- (void)chatSessionPersistentNotificationControllerNeedsUpdatedHeight:(id)arg1;
- (void)chatSessionPersistentNotificationViewWasTapped:(id)arg1;
- (id)changeNumberNotificationTitle;
- (void)chatSessionPersistentNotificationViewDidDismiss:(id)arg1;
- (void)removePersistentNotificationAnimated:(BOOL)arg1;
- (void)layoutPersistentNotificationAnimated:(BOOL)arg1;
- (void)updateChangeNumberPersistentNotificationContent;
- (void)updatePersistentNotificationIfNecessaryAnimated:(BOOL)arg1;
- (BOOL)shouldPresentPersistentNotificationForChangeNumber;
- (BOOL)shouldPresentPersistentNotificationForGroupDescription;
- (void)layoutPersistentNotificationIfNecessary;
...
- (void)showMoreGroupAdminsFromViewController:(id)arg1;
...
- (void)chatMessageInputView:(id)arg1 sendInterruptedPTTRecording:(id)arg2;
...
- (void)chatMessageInputView:(id)arg1 didEndPTTRecordingByInterruption:(BOOL)arg2;
...
- (void)appendPotentialMessagesForCatchUp:(id)arg1 andIncrementScrollToBottom:(unsigned int)arg2;
- (BOOL)messageIsEligibleForCatchUp:(id)arg1;
- (BOOL)isGroupCatchUpEnabled;
...
- (void)stopPTTRecordingByInterruption:(BOOL)arg1;
