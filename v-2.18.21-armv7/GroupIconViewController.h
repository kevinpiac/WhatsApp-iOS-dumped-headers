...
@class NSString, UIActivityIndicatorView, UIBarButtonItem, UIImageView, WAActivityLabel, WAImageToImagePanPopGestureRecognizer, WAProfilePictureScrollView;
...
@property(nonatomic) BOOL panPopGestureDisabled; // @synthesize panPopGestureDisabled=_panPopGestureDisabled;
