...
@property(nonatomic) BOOL gifPlayback; // @dynamic gifPlayback;
...
@property(nonatomic) BOOL hasGifAttribution; // @dynamic hasGifAttribution;
@property(nonatomic) BOOL hasGifPlayback; // @dynamic hasGifPlayback;
