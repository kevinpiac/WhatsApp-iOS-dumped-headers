...
@property(nonatomic) BOOL cellSelected; // @synthesize cellSelected=_cellSelected;
...
- (void)configureWithShowRemainingContactCount:(unsigned int)arg1 cellConfiguration:(id)arg2;
