...
@class NSData, NSDate, NSError, NSString, WAMMSDownloadFileTask, WAMMSMediaDownloadOperationRequest, WAMMSMediaTransferOperationAsset, WAMMSTaskSession, WamEventMediaDownload;
