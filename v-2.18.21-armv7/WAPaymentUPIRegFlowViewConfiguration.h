...
@interface WAPaymentUPIRegFlowViewConfiguration : NSObject
{
    ...
    unsigned int _leftNavigationItemType;
    NSString *_titleText;
...
@property(retain, nonatomic) NSDictionary *linkAssociations; // @synthesize linkAssociations=_linkAssociations;
...
@property(nonatomic) unsigned int leftNavigationItemType; // @synthesize leftNavigationItemType=_leftNavigationItemType;
