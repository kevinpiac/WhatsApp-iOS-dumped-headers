...
@interface WAStickerPickerManager : NSObject <NSFetchedResultsControllerDelegate, WAGimmickPickerViewConfiguring, UICollectionViewDelegate, UICollectionViewDataSource, WAStickerCategoriesFlowLayoutDelegate>
{
    ...
    BOOL _emotionCategoriesExpanded;
    unsigned int _emotionCategoriesChangedCount;
...
- (unsigned int)stickerCategoriesFlowLayoutCategoriesCount:(id)arg1;
...
- (BOOL)stickerCategoriesFlowLayoutShouldAddDecoration:(id)arg1;
- (BOOL)stickerCategoriesFlowLayout:(id)arg1 shouldProcessFinalLayoutWithIndexPath:(id)arg2;
- (BOOL)stickerCategoriesFlowLayout:(id)arg1 shouldProcessInitialLayoutWithIndexPath:(id)arg2;
...
- (void)updateEmotionCategoryRow:(unsigned int)arg1 withEmotion:(unsigned int)arg2;
