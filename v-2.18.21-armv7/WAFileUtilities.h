...
+ (BOOL)writeAllBytes:(const void *)arg1 ofLength:(unsigned long)arg2 toFile:(int)arg3;
+ (long)readBytes:(void *)arg1 ofLength:(unsigned long)arg2 fromFile:(int)arg3;
+ (void)purgeOrphanedChatMediaDirectories;
+ (void)wa_didUpgradeFrom:(id)arg1 to:(id)arg2;
+ (unsigned int)removeContentsOfDirectoryAtPath:(id)arg1 skippingFilesWithNames:(id)arg2 andPrefixes:(id)arg3;
+ (unsigned int)removeContentsOfDirectoryAtPath:(id)arg1 olderThan:(double)arg2 withPrefix:(id)arg3;
...
+ (unsigned long long)logItemAtPath:(id)arg1 withDepth:(unsigned int)arg2;
