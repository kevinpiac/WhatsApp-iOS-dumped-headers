...
@class ExecutionTimeProfiler, GCDAsyncSocket, NSArray, NSMutableArray, NSMutableData, NSNumber, NSString, WADNSMetrics, WADNSResolver, WAInetAddress, WATimer, XMPPEndpoint;
...
@interface XMPPSocket : NSObject <GCDAsyncSocketDelegate>
{
    ...
    ExecutionTimeProfiler *_socketProfiler;
    BOOL _socketEventSentWithCurrentStateMachine;
...
@property(nonatomic) BOOL useDefaultPortFirst; // @synthesize useDefaultPortFirst=_useDefaultPortFirst;
@property BOOL useFBHosts; // @synthesize useFBHosts=_useFBHosts;
@property(retain) WAInetAddress *hintIP; // @synthesize hintIP=_hintIP;
@property(nonatomic) BOOL bindsToCellularNetwork; // @synthesize bindsToCellularNetwork=_bindsToCellularNetwork;
...
- (id)interleavedFallbackAddressEndpointsWithOverride:(BOOL)arg1 limit:(unsigned int)arg2;
