...
@property(nonatomic) BOOL hasNotifyMessageCount; // @dynamic hasNotifyMessageCount;
@property(nonatomic) BOOL hasTimestamp; // @dynamic hasTimestamp;
@property(nonatomic) BOOL hasUnreadChats; // @dynamic hasUnreadChats;
...
@property(readonly, nonatomic) unsigned int notifyMessagesArray_Count; // @dynamic notifyMessagesArray_Count;
