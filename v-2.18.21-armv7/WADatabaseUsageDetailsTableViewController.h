...
@class NSMutableArray, UIActivityIndicatorView, UILabel, UITableViewCell, WADiskUsageRowData, WADiskUsageTableViewController, WADiskUsageThumbnailView;
...
- (BOOL)isAnyTypeSelected;
- (void)applyEditingTransition:(BOOL)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (BOOL)canSelectResult:(id)arg1;
