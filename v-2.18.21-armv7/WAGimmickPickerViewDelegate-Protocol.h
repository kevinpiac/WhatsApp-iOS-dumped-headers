...
@class WAGIFAssetCollection, WAGimmickPickerView, WAManagedSticker, WAMultiSendMediaItem;
...
- (void)gimmickPickerView:(WAGimmickPickerView *)arg1 didSelectManagedSticker:(WAManagedSticker *)arg2;
@end
