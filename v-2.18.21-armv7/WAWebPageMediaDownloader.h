...
@interface WAWebPageMediaDownloader : NSObject <NSURLSessionDataDelegate>
{
    ...
    unsigned int _downloadableMediaSize;
...
@property(readonly, nonatomic) unsigned int downloadableMediaSize; // @synthesize downloadableMediaSize=_downloadableMediaSize;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) BOOL mediaDownloadOngoing;
