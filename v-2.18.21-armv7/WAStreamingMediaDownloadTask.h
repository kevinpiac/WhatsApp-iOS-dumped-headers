...
- (void)cancel;
- (void)resume;
- (id)initWithTaskSession:(id)arg1 taskDescription:(id)arg2 requestRange:(struct _NSRange)arg3 priority:(float)arg4 allowsCellularAccess:(BOOL)arg5 delegate:(id)arg6 callbackQueue:(id)arg7;
