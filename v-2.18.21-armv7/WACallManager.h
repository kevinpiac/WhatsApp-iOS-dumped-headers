...
@property BOOL audioRestartOnRouteChange; // @synthesize audioRestartOnRouteChange=_audioRestartOnRouteChange;
@property BOOL audioInterruptionPoll; // @synthesize audioInterruptionPoll=_audioInterruptionPoll;
@property int spamCallThresholdSeconds; // @synthesize spamCallThresholdSeconds=_spamCallThresholdSeconds;
@property int vibrateSecs; // @synthesize vibrateSecs=_vibrateSecs;
@property BOOL badASN; // @synthesize badASN=_badASN;
@property BOOL uploadFieldStatsAtCallEnd; // @synthesize uploadFieldStatsAtCallEnd=_uploadFieldStatsAtCallEnd;
@property BOOL shouldUploadLogs; // @synthesize shouldUploadLogs=_shouldUploadLogs;
@property BOOL shouldEnableAudioVideoSwitchNextCall; // @synthesize shouldEnableAudioVideoSwitchNextCall=_shouldEnableAudioVideoSwitchNextCall;
@property float dimScreenInVideoCallPercentage; // @synthesize dimScreenInVideoCallPercentage=_dimScreenInVideoCallPercentage;
...
@property BOOL endCallInProgress; // @synthesize endCallInProgress=_endCallInProgress;
...
@property BOOL showRatingScreenForCall; // @synthesize showRatingScreenForCall=_showRatingScreenForCall;
...
- (void)startOutgoingCallWith:(id)arg1 withVideo:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
- (void)attemptOutgoingCellularVoiceCallWithPhoneURL:(id)arg1;
- (void)internalAttemptOutgoingVoiceCallWithJID:(id)arg1 callUISource:(int)arg2 withVideo:(BOOL)arg3;
...
@property(readonly, nonatomic) BOOL isInitiatingCall;
@property(readonly, nonatomic) BOOL isCallStarted;
@property(readonly, nonatomic) BOOL isCallActive;
- (void)acceptCall;
- (void)rejectCallUnavailableWithBlockedReason:(BOOL)arg1;
- (void)rejectCall;
- (void)endCall:(BOOL)arg1;
- (void)mute:(BOOL)arg1;
- (BOOL)handleCallAcceptedFromCallKit:(id)arg1;
...
- (void)initializeCallStateWithPeerJid:(id)arg1 isCaller:(BOOL)arg2 isVideo:(BOOL)arg3;
- (void)dealloc;
- (void)doVoIPInit;
- (id)init;
- (void)notifyGroupCallNotSupportedByJID:(id)arg1;
- (void)notifyUncallableUserWithJID:(id)arg1 isVideoCall:(BOOL)arg2;
...
- (void)setVideoStreamPause:(BOOL)arg1 isCapture:(BOOL)arg2;
...
- (void)setPeerVideoBounds:(struct CGRect)arg1 center:(struct CGPoint)arg2 forParticipantJID:(id)arg3 isUserAction:(BOOL)arg4;
- (void)setPeerVideoBounds:(struct CGRect)arg1 center:(struct CGPoint)arg2 forParticipantJID:(id)arg3 animateWithDuration:(double)arg4 isUserAction:(BOOL)arg5;
...
- (void)turnCameraOff;
- (void)turnCameraOn;
@property(readonly, nonatomic) BOOL shouldEnableAudioVideoSwitch;
@property(readonly, nonatomic) BOOL callHasVideo;
...
- (void)initCallWithVideo:(BOOL)arg1;
- (float)getVoipParamAsFloat:(id)arg1;
- (BOOL)getVoipParamAsBool:(id)arg1;
- (int)getVoipParamAsInt:(id)arg1;
- (BOOL)hasVoipParam:(id)arg1;
...
- (void)sanityCheck:(id)arg1 verifyDuration:(BOOL)arg2;
- (BOOL)isLargeStanza:(id)arg1;
- (void)sendCallReceiptOrAck:(id)arg1 verifyDuration:(BOOL)arg2;
...
- (BOOL)getVideoFromStanza:(id)arg1;
...
- (BOOL)setCallDurationForStanza:(id)arg1 withCallInfo:(id)arg2;
