...
+ (id)dictionaryWithBools:(const char *)arg1 forKeys:(const unsigned long long *)arg2 count:(unsigned int)arg3;
...
- (id)initWithBools:(const char *)arg1 forKeys:(const unsigned long long *)arg2 count:(unsigned int)arg3;
- (id)init;
