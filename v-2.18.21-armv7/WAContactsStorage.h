...
+ (id)notificationHashDataFromString:(id)arg1 length:(unsigned int)arg2;
...
- (id)statusRecipients;
- (void)processResultsOfFullSync:(BOOL)arg1 usingContext:(id)arg2 listContacts:(id)arg3 sidelistContacts:(id)arg4 statusEntries:(id)arg5;
