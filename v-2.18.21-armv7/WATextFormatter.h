...
+ (id)formattingSymbolFromStyle:(int)arg1;
...
- (void)parseStrikeThrough:(id)arg1 withLengthCorrection:(BOOL)arg2;
- (void)parseItalic:(id)arg1 withLengthCorrection:(BOOL)arg2;
- (void)parseBold:(id)arg1 withLengthCorrection:(BOOL)arg2;
- (void)parseBlockMonoSpace:(id)arg1 withLengthCorrection:(BOOL)arg2;
