...
- (void)webClient:(WAWebClient *)arg1 didRequestMediaUploadForMessageID:(WAMessageID *)arg2 inChatWithJID:(NSString *)arg3 extraRecipientJIDs:(NSSet *)arg4 completion:(void (^)(unsigned int, NSString *, NSData *))arg5;
...
- (unsigned int)webClient:(WAWebClient *)arg1 didSeeStatus:(WAMessageID *)arg2 inChatWithJID:(NSString *)arg3;
...
- (NSArray *)webClient:(WAWebClient *)arg1 starredMessagesInChatWithJID:(NSString *)arg2 olderThanMessageID:(WAMessageID *)arg3 limit:(unsigned int)arg4 gifOnly:(BOOL)arg5 context:(NSManagedObjectContext *)arg6;
...
- (unsigned int)webClient:(WAWebClient *)arg1 countMediaMessagesInChatSession:(WAChatSession *)arg2;
- (unsigned int)webClient:(WAWebClient *)arg1 countMessagesInChatSession:(WAChatSession *)arg2 ofType:(int)arg3;
- (NSArray *)webClient:(WAWebClient *)arg1 mediaMessagesInChatSession:(WAChatSession *)arg2 count:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(WAMessageID *)arg5;
- (NSArray *)webClient:(WAWebClient *)arg1 messagesInChatSession:(WAChatSession *)arg2 ofType:(int)arg3 count:(unsigned int)arg4 withRelation:(unsigned int)arg5 toMessageID:(WAMessageID *)arg6;
- (NSArray *)webClient:(WAWebClient *)arg1 messagesInChatSession:(WAChatSession *)arg2 count:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(WAMessageID *)arg5;
@end
