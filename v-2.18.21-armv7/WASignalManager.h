...
+ (float)statsFromCiphertextType:(unsigned int)arg1;
...
@property BOOL needsRegistration; // @synthesize needsRegistration=_needsRegistration;
...
- (void)didReceivePrekeyUploadRequestWithCurrentKeyCount:(unsigned int)arg1;
...
- (void)processClientServerKeyBundleSyncCompletionHandlersWithResult:(unsigned int)arg1 error:(id)arg2;
...
- (void)handleDecryptResultForRequest:(id)arg1 protobuf:(id)arg2 decryptJournalId:(id)arg3 error:(id)arg4 endDeferringStoreSaves:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)fetchSignalIdentityPublicKeyForJid:(id)arg1 requestFromServerIfNeeded:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)locationGroupJID;
- (void)constructSenderKeyDistributionMessageDataWithFetch:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
...
- (BOOL)encryptIndividualRequest:(id)arg1 result:(out id *)arg2 error:(out id *)arg3;
