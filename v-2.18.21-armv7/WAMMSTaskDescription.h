...
- (id)initWithMediaType:(unsigned int)arg1 hashIdentifier:(id)arg2 directPath:(id)arg3 mms3DownloadURLOverride:(id)arg4 uploadJID:(id)arg5 taskType:(unsigned int)arg6;
- (id)initForUploadWithMediaType:(unsigned int)arg1 hashIdentifier:(id)arg2 uploadJID:(id)arg3 taskType:(unsigned int)arg4;
- (id)initForDownloadWithMediaType:(unsigned int)arg1 hashIdentifier:(id)arg2 directPath:(id)arg3 mms3DownloadURLOverride:(id)arg4;
