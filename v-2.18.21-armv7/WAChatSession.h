...
@property(readonly, nonatomic) BOOL usesSubjectText;
...
@property(readonly, nonatomic) BOOL currentUserCanMessageChat;
@property(readonly, nonatomic) BOOL readonlyAnnouncementOnlyGroup;
@property(readonly, nonatomic) BOOL currentUserCanEditGroup;
@property(readonly, nonatomic) BOOL currentUserIsAdmin;
