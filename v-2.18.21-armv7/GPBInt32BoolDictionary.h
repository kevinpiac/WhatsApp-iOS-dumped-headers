...
+ (id)dictionaryWithBools:(const char *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
+ (id)dictionaryWithBool:(BOOL)arg1 forKey:(int)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeBoolForKey:(int)arg1;
- (void)setBool:(BOOL)arg1 forKey:(int)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getBool:(char *)arg1 forKey:(int)arg2;
...
- (id)initWithBools:(const char *)arg1 forKeys:(const int *)arg2 count:(unsigned int)arg3;
- (id)init;
