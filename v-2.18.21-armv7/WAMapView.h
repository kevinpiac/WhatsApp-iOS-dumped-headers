...
@class CLGeocoder, CLLocation, CLPlacemark, MKMapCamera, MKMapView, MKUserLocation, NSArray, NSString, UITapGestureRecognizer, WA2DMapButton, WAInfoButton, WAMapButtonContainer, WAMapViewGestureRecognizer, WAStaticPinButton, WAUserTrackingButton;
...
+ (BOOL)gestureRecognizerIsTilt:(id)arg1;
