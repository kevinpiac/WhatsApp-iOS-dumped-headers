...
@property(copy, nonatomic) NSString *mediaUploadPath; // @synthesize mediaUploadPath=_mediaUploadPath;
...
@property(nonatomic, getter=isMediaSaved) BOOL mediaSaved; // @synthesize mediaSaved=_mediaSaved;
- (void).cxx_destruct;
- (id)fetchEncHash;
- (id)fetchMediaKey;
