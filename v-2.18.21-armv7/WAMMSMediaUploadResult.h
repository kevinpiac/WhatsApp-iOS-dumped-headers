...
@property(readonly, nonatomic) BOOL reuploading; // @synthesize reuploading=_reuploading;
...
- (void).cxx_destruct;
- (id)initWithMediaURL:(id)arg1 directPath:(id)arg2 mediaKey:(id)arg3 plaintextHash:(id)arg4 encFileHash:(id)arg5 sidecar:(id)arg6 reuploading:(BOOL)arg7;
