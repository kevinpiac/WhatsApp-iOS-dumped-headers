...
@property(readonly, nonatomic) unsigned int methodsArray_Count; // @dynamic methodsArray_Count;
@property(retain, nonatomic) NSMutableArray *mixinsArray; // @dynamic mixinsArray;
@property(readonly, nonatomic) unsigned int mixinsArray_Count; // @dynamic mixinsArray_Count;
