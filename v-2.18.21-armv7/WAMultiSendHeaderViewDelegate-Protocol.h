...
@class NSDictionary, WAMultiSendHeaderView, WAPaintBrushContent;

@protocol WAMultiSendHeaderViewDelegate <NSObject>
- (float)multiSendHeaderViewCaptionBarHeight:(WAMultiSendHeaderView *)arg1;
...
- (void)multiSendHeaderView:(WAMultiSendHeaderView *)arg1 didRequestAddNewStamp:(WAPaintBrushContent *)arg2;
- (void)multiSendHeaderView:(WAMultiSendHeaderView *)arg1 didSelectTextStyle:(NSDictionary *)arg2;
...
- (BOOL)isRedoPossibleForMultiSendHeaderView:(WAMultiSendHeaderView *)arg1;
- (BOOL)isUndoPossibleForMultiSendHeaderView:(WAMultiSendHeaderView *)arg1;
...
- (BOOL)isDeletePossibleForMultiSendHeaderView:(WAMultiSendHeaderView *)arg1;
...
- (void)multiSendHeaderView:(WAMultiSendHeaderView *)arg1 didUpdateAutoCropInteractionProgress:(float)arg2;
- (void)multiSendHeaderViewWillBeginAutoCropInteraction:(WAMultiSendHeaderView *)arg1;
- (BOOL)isAutoCropInteractionPossibleForMultiSendHeaderView:(WAMultiSendHeaderView *)arg1;
- (BOOL)isCroppingPossibleForMultiSendHeaderView:(WAMultiSendHeaderView *)arg1;
@end
