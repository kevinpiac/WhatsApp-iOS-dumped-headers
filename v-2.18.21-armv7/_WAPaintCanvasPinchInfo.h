...
@property(nonatomic, getter=isSnappingToAngle) BOOL snappingToAngle; // @synthesize snappingToAngle=_snappingToAngle;
- (void).cxx_destruct;
- (void)resetBaseline;
@property(readonly, nonatomic) BOOL needsSnapToAngle;
- (id)init;
