...
@interface WAChatManager : WAChatDataStoreCoordinator <WAChatDataStoreDelegate, WAWebClientDelegate, XMPPConnectionDelegate, WASyncManagerDelegate, WAContactsStorageDelegate, WAMessageNotificationCenterDelegate>
{
    ...
    BOOL _needsAddressBookReload;
    BOOL _addressBookReloadingInProgress;
    BOOL _ignoreAddressBookChangeNotifications;
    BOOL _timelocked;
...
@property(nonatomic) BOOL ignoreAddressBookChangeNotifications; // @synthesize ignoreAddressBookChangeNotifications=_ignoreAddressBookChangeNotifications;
...
@property(nonatomic) BOOL needsAddressBookReload; // @synthesize needsAddressBookReload=_needsAddressBookReload;
...
- (BOOL)isWebClientActiveForMessageNotificationCenter:(id)arg1;
...
- (id)internalSetChatSession:(id)arg1 unreadCount:(int)arg2 mostRecentReadMessage:(id)arg3 fromWebClient:(BOOL)arg4 sendReadReceipts:(BOOL)arg5;
- (BOOL)markMessageRead:(id)arg1 readCount:(int)arg2 fromWebClient:(BOOL)arg3;
- (void)markChatSessions:(id)arg1 read:(BOOL)arg2 fromWebClient:(BOOL)arg3 sendReadReceipts:(BOOL)arg4;
...
- (id)webClient:(id)arg1 starredMessagesInChatWithJID:(id)arg2 olderThanMessageID:(id)arg3 limit:(unsigned int)arg4 gifOnly:(BOOL)arg5 context:(id)arg6;
...
- (unsigned int)unstarMessagesWithJIDs:(id)arg1;
...
- (unsigned int)webClient:(id)arg1 didSeeStatus:(id)arg2 inChatWithJID:(id)arg3;
...
- (id)webClient:(id)arg1 JIDToChatSessionMapWithJIDs:(id)arg2 context:(id)arg3;
- (unsigned int)webClient:(id)arg1 countMediaMessagesInChatSession:(id)arg2;
- (unsigned int)webClient:(id)arg1 countMessagesInChatSession:(id)arg2 ofType:(int)arg3;
- (id)webClient:(id)arg1 mediaMessagesInChatSession:(id)arg2 count:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(id)arg5;
- (id)webClient:(id)arg1 messagesInChatSession:(id)arg2 ofType:(int)arg3 count:(unsigned int)arg4 withRelation:(unsigned int)arg5 toMessageID:(id)arg6;
- (id)webClient:(id)arg1 messagesInChatSession:(id)arg2 count:(unsigned int)arg3 withRelation:(unsigned int)arg4 toMessageID:(id)arg5;
