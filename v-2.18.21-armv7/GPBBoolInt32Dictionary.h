...
+ (id)dictionaryWithInt32s:(const int *)arg1 forKeys:(const char *)arg2 count:(unsigned int)arg3;
+ (id)dictionaryWithInt32:(int)arg1 forKey:(BOOL)arg2;
+ (id)dictionary;
- (void)removeAll;
...
- (id)initWithInt32s:(const int *)arg1 forKeys:(const char *)arg2 count:(unsigned int)arg3;
- (id)init;
