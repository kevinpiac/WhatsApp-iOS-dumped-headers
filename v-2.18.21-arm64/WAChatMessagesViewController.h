...
@interface WAChatMessagesViewController : WAChatBackgroundViewController <ABPeoplePickerNavigationControllerDelegate, ABDisabledControllerDelegate, CNContactPickerDelegate, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, WAContactEditViewControllerDelegate, EKEventEditViewDelegate, WAMessageBubbleTableViewCellDelegate, WAChatMessagesControllerDelegate, WAPaymentUPICoordinatorDelegate, UIViewControllerPreviewingDelegate, WATableViewCellPreviewingDelegate, WAVCardMessagePreviewActionDelegate, UIViewControllerAnimatedTransitioning, WAImageToImageTransitioning, WANavigationControllerPopToAnimating, UITableViewDelegate, UITableViewDataSource, WAMessagePresenter>
{
    ...
    _Bool _needsDeferredLoadEarlierOrLaterMessages;
    ...
    _Bool _neeedsInitialMessagesControllerSetUp;
...
@property(readonly, nonatomic) _Bool needsScrollToTarget; // @synthesize needsScrollToTarget=_needsScrollToTarget;
...
- (long long)countOfAllSelectedMessages;
...
- (void)scrollToMessageInMessagesController:(id)arg1 animated:(_Bool)arg2 highlightAfterScroll:(_Bool)arg3;
- (void)scrollToTarget;
- (void)setNeedsScrollToMessage:(id)arg1 highlightAfterScroll:(_Bool)arg2;
...
@property(readonly, nonatomic, getter=isIgnoringAnimatedContentOffsetChanges) _Bool ignoringAnimatedContentOffsetChanges;
...
- (void)callContactWithJID:(id)arg1 callUISource:(int)arg2 withVideo:(_Bool)arg3;
...
- (_Bool)loadLaterMessagesIfNeeded;
- (_Bool)loadEarlierMessagesIfNeeded;
...
- (void)addMessagesToTheBottom:(id)arg1 firstUnreadMessage:(id)arg2 updateMessages:(id)arg3 animated:(_Bool)arg4 dividerBehavior:(unsigned long long)arg5 allowScrolling:(_Bool)arg6 searchResultMessageID:(id)arg7 skipAlbumCreation:(_Bool)arg8;
