...
- (void)sendGenericErrorResponse:(long long)arg1 andAckNotification:(id)arg2;
- (void)notifyGenericErrorResponse:(long long)arg1 requestID:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)internalHandleSetStatusPrivacyTo:(long long)arg1 element:(id)arg2 inNotification:(id)arg3;
...
- (void)setBlocked:(_Bool)arg1 forElement:(id)arg2 inNotification:(id)arg3;
...
- (void)setStarredState:(_Bool)arg1 forElement:(id)arg2 inNotification:(id)arg3;
...
- (void)setArchivedState:(_Bool)arg1 forElement:(id)arg2 inNotification:(id)arg3;
