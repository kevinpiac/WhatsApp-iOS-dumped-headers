...
+ (_Bool)wa_isSourceEXIFMetadataAllowed:(struct CGImageSource *)arg1;
...
- (_Bool)wa_exportToImageFileURL:(id)arg1 quality:(double)arg2 preferredMaximumLength:(unsigned long long)arg3 MIMEType:(id)arg4;
...
- (_Bool)wa_isNormalizedImageReturningOpaque:(out _Bool *)arg1;
