...
- (_Bool)isMessageStanzaRecentlyAcked:(id)arg1;
...
- (void)subscribeToLocationUpdatesFromContactJID:(id)arg1 reportParticipants:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)createGroupWithSubject:(id)arg1 description:(id)arg2 participantJIDs:(id)arg3 key:(id)arg4 locked:(_Bool)arg5 webClientRequestID:(id)arg6 completion:(CDUnknownBlockType)arg7;
