...
- (void)regularMediaDownloader:(id)arg1 didFailToDownloadMediaInMessage:(id)arg2 autodownload:(_Bool)arg3 error:(id)arg4;
...
- (void)streamingMediaLoaderManager:(id)arg1 didFailToDownloadMediaInMessage:(id)arg2 userInitiated:(_Bool)arg3 error:(id)arg4;
