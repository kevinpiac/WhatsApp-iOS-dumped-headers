...
+ (id)fullNameOrFormattedPhoneNumberForJID:(id)arg1 forVoiceOver:(_Bool)arg2 verifiedBadgePlaceholder:(id)arg3;
...
+ (id)localizedGroupEventDescriptionForMessage:(id)arg1 forVoiceOver:(_Bool)arg2 verifiedBadgePlaceholder:(id)arg3;
