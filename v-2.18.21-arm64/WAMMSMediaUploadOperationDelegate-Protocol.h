...
- (void)uploadTask:(WAMMSMediaUploadOperation *)arg1 didFinishWithResult:(WAMMSMediaUploadOperationResult *)arg2 uploadEvent:(WamEventMediaUpload *)arg3 error:(NSError *)arg4 terminal:(_Bool)arg5;
