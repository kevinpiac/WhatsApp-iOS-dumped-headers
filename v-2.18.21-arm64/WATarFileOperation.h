...
@interface WATarFileOperation : WASynchronousBackupOperation
{
    ...
    _Bool _optimizeFileSystem;
    _Bool _didWorkaroundFail;
    NSString *_path;
    CDUnknownBlockType _completion;
}

@property(copy) CDUnknownBlockType completion; // @synthesize completion=_completion;
@property _Bool didWorkaroundFail; // @synthesize didWorkaroundFail=_didWorkaroundFail;
@property _Bool optimizeFileSystem; // @synthesize optimizeFileSystem=_optimizeFileSystem;
