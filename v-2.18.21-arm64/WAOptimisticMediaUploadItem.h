...
@interface WAOptimisticMediaUploadItem : NSObject
{
    ...
    unsigned long long _uploadDelaySeconds;
}

+ (unsigned long long)uploadDelaySecondsForMediaPickerOrigin:(unsigned long long)arg1;
+ (id)identifierForMediaItem:(id)arg1;
@property(readonly, nonatomic) unsigned long long uploadDelaySeconds; // @synthesize uploadDelaySeconds=_uploadDelaySeconds;
...
- (id)initWithMediaItem:(id)arg1 quality:(id)arg2 mediaPickerOrigin:(unsigned long long)arg3;
