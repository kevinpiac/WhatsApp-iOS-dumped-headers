...
- (void)handleDecryptResultForRequest:(id)arg1 protobuf:(id)arg2 decryptJournalId:(id)arg3 error:(id)arg4 endDeferringStoreSaves:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
