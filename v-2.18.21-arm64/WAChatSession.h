...
{
    unsigned long long _statusMessageCount;
...
+ (id)listOfContactNamesForContacts:(id)arg1 onlyMatchingJIDs:(id)arg2 prioritizingContactsWithJIDs:(id)arg3 unsorted:(_Bool)arg4 verifiedBadgePlaceholder:(id)arg5;
...
- (id)firstNamesOfActiveGroupMembersWithJIDs:(id)arg1 limit:(long long)arg2 listFirst:(id)arg3 verifiedBadgePlaceholder:(id)arg4;
...
- (void)provideStatusMessageCount:(unsigned long long)arg1;
