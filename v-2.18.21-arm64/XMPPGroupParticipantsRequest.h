...
+ (void)modifyRequestsWithJID:(id)arg1 shouldInitialize:(_Bool)arg2 action:(CDUnknownBlockType)arg3;
+ (_Bool)hasPendingRequestsForGroupJID:(id)arg1 participantJID:(id)arg2;
