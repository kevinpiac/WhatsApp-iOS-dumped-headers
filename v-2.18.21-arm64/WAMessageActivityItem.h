...
@property(readonly, nonatomic) unsigned long long arrayCount; // @synthesize arrayCount=_arrayCount;
@property(readonly, nonatomic) WAMessage *message; // @synthesize message=_message;
- (void).cxx_destruct;
- (id)activityViewController:(id)arg1 subjectForActivityType:(id)arg2;
- (id)activityViewController:(id)arg1 itemForActivityType:(id)arg2;
- (id)activityViewControllerPlaceholderItem:(id)arg1;
- (id)initWithMessage:(id)arg1 arrayCount:(unsigned long long)arg2;
