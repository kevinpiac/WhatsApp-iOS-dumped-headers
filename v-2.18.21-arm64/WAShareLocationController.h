...
- (void)updateNavigationBarForOrientation:(long long)arg1 showingLiveLocationCard:(_Bool)arg2;
...
- (void)dealloc;
- (id)initWithShareDelegate:(id)arg1 chatSession:(id)arg2 entrypoint:(long long)arg3;
