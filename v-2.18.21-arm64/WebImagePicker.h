...
@interface WebImagePicker : UINavigationController <ImageSearchControllerDelegate>
{
    WAHTTPFetcher *_httpFetcher;
    id <WebImagePickerDelegate> _pickerDelegate;
}

@property(nonatomic) __weak id <WebImagePickerDelegate> pickerDelegate; // @synthesize pickerDelegate=_pickerDelegate;
- (void).cxx_destruct;
