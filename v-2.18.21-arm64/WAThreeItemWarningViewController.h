...
{
    _Bool _allowsUserToContinueUsingApp;
    UILabel *_labelItem1;
    UILabel *_labelItem2;
    UILabel *_labelItem3;
    UILabel *_labelTitle;
...
@property(nonatomic) _Bool allowsUserToContinueUsingApp; // @synthesize allowsUserToContinueUsingApp=_allowsUserToContinueUsingApp;
