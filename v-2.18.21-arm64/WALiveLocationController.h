...
- (_Bool)requestLocationRetryFrom:(id)arg1 retryCount:(long long)arg2;
...
- (void)reallyStopSharingLocationWithContact:(id)arg1 message:(id)arg2 userOriginatedCancel:(_Bool)arg3;
...
- (void)stopSharingLocationInMessage:(id)arg1 contact:(id)arg2 userOriginatedCancel:(_Bool)arg3;
