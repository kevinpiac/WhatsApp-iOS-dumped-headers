...
- (id)insertOutgoingMessageOfType:(int)arg1 insertMediaItem:(_Bool)arg2;
...
- (void)addParticipants:(id)arg1 insertMessage:(_Bool)arg2 authorJID:(id)arg3 viaInviteLink:(_Bool)arg4 fromOffline:(_Bool)arg5 timestamp:(id)arg6;
- (void)addParticipant:(id)arg1 insertMessage:(_Bool)arg2;
- (void)insertIndividualJoinMessageForParticipant:(id)arg1 authorJID:(id)arg2 viaInviteLink:(_Bool)arg3 fromOffline:(_Bool)arg4 timestamp:(id)arg5;
