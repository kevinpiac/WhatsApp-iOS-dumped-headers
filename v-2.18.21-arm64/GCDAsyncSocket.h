...
- (int)blockUntilReadStreamOpened:(struct __CFReadStream *)arg1 withTimeout:(double)arg2;
- (void)wa_connectImplWithUnopenedReadStream:(struct __CFReadStream *)arg1 unopenedWriteStream:(struct __CFWriteStream *)arg2 withTimeout:(double)arg3 completion:(CDUnknownBlockType)arg4;
- (_Bool)wa_connectWithAddress4:(id)arg1 address6:(id)arg2 timeout:(double)arg3 error:(id *)arg4;
- (_Bool)wa_connectWithCFHost:(struct __CFHost *)arg1 onPort:(unsigned short)arg2 withTimeout:(double)arg3 error:(id *)arg4;
