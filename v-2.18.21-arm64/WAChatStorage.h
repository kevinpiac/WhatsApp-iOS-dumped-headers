...
+ (id)backupKeyForStanzaID:(id)arg1 isFromMe:(_Bool)arg2 remoteJID:(id)arg3;
+ (id)messagesForSession:(id)arg1 minSort:(int)arg2 maxSort:(int)arg3 limit:(unsigned long long)arg4 ascending:(_Bool)arg5 withMoc:(id)arg6;
+ (id)messagesForSession:(id)arg1 limit:(unsigned long long)arg2 ascending:(_Bool)arg3 withMoc:(id)arg4;
...
- (id)initWithUniqueIdentifier:(id)arg1 modelName:(id)arg2 storeURL:(id)arg3 blacklistBackup:(_Bool)arg4;
...
- (id)newOrExistingChatSessionsForJIDs:(id)arg1 preferredContacts:(id)arg2 options:(unsigned long long)arg3;
- (id)newOrExistingChatSessionsForGroupMembers:(id)arg1 options:(unsigned long long)arg2;
...
- (id)newOrExistingChatSessionForJID:(id)arg1 preferredContact:(id)arg2 options:(unsigned long long)arg3;
...
@property(readonly, nonatomic) _Bool hasUnarchivedUnreadChatSessions;
...
- (void)addMessagesForBackupMessages:(id)arg1 includesSort:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)messagesWithPredicate:(id)arg1 startOffset:(unsigned long long)arg2 limit:(unsigned long long)arg3;
- (id)downloadedStarredMessagesOfType:(int)arg1 startOffset:(unsigned long long)arg2 limit:(unsigned long long)arg3;
- (id)starredMessagesOfType:(int)arg1 startOffset:(unsigned long long)arg2 limit:(unsigned long long)arg3;
...
- (void)indexVCardMentionsForMessages:(id)arg1 context:(id)arg2 contactsStorage:(id)arg3 saveChanges:(_Bool)arg4;
...
- (id)recentMessagesInChatSession:(id)arg1 activity:(long long)arg2;
- (id)messagesForChatSession:(id)arg1 offset:(long long)arg2 limit:(long long)arg3;
