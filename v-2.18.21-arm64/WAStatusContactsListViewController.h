...
@interface WAStatusContactsListViewController : WATableViewController <WAMultiSendMediaPickerControllerDelegate, WAMultiShotCameraControllerDelegate, WAOutgoingStatusChatSessionCellDelegate, WAStatusListNUXCellDelegate, WAStatusTextComposerViewControllerDelegate, WAStatusViewerViewControllerDelegate, WACircleMovePresentationControllerDelegate, WAContactEditViewControllerDelegate, ABDisabledControllerDelegate, NSFetchedResultsControllerDelegate>
{
    ...
    _Bool _needsSetUpFetchRequests;
    _Bool _rankingUpdated;
    _Bool _didReceiveMoveChangeEvent;
    _Bool _muteUnmuteInProgress;
    unsigned long long _unseenChatSessionCount;
    _Bool _seeAllEnabled;
    _Bool _isUpdatingTable;
    _Bool _showNUX;
    _Bool _shouldShowSeeAllCell;
    _Bool _shouldShowNoRecentsCell;
    _Bool _shouldShowNoContactsCell;
    _Bool _needsReloadData;
    unsigned long long _deletedElementsInBatch;
...
- (_Bool)isHiddenIndexPath:(id)arg1 withUnseenChatSessionCount:(unsigned long long)arg2;
...
- (void)setSeeAllEnabled:(_Bool)arg1;
...
- (long long)elementsInSection:(unsigned long long)arg1;
...
@property(readonly, nonatomic) _Bool areFetchRequestsSetUp;
