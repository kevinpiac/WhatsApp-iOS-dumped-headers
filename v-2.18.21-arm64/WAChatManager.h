...
- (unsigned long long)webClient:(id)arg1 didPin:(_Bool)arg2 chatWithJID:(id)arg3 pinDate:(id)arg4;
- (unsigned long long)webClient:(id)arg1 didSetMute:(_Bool)arg2 ofStatusWithJID:(id)arg3;
...
- (unsigned long long)unstarMessagesWithJIDs:(id)arg1;
- (unsigned long long)webClient:(id)arg1 didSetStarredState:(_Bool)arg2 ofMessageIDs:(id)arg3 inChatWithJID:(id)arg4;
- (unsigned long long)webClient:(id)arg1 didSetMuteDate:(id)arg2 fromMuteDate:(id)arg3 ofChatWithJID:(id)arg4;
- (unsigned long long)webClient:(id)arg1 didSetArchivedState:(_Bool)arg2 ofChatWithJID:(id)arg3 messageID:(id)arg4;
...
- (unsigned long long)webClient:(id)arg1 didSeeStatus:(id)arg2 inChatWithJID:(id)arg3;
...
- (id)webClient:(id)arg1 recentMessagesInChatSession:(id)arg2 activity:(long long)arg3;
- (id)webClient:(id)arg1 memberJIDsInBroadcastList:(id)arg2;
- (id)webClient:(id)arg1 messagesInChatSession:(id)arg2 afterMessageID:(id)arg3 count:(unsigned long long)arg4 countExceeded:(out _Bool *)arg5;
...
- (void)notifyWebClientOfGenericErrorCode:(long long)arg1 requestID:(id)arg2;
